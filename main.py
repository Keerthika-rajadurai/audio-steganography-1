...
def phaseEncoding(textUrl, audioUrl):
    # INPUT NEW TEXT AND AUDIO FILE: ~~~~~~~~~~
    ssl._create_default_https_context = ssl._create_unverified_context  
    wget.download(textUrl, out="text.txt")
    wget.download(audioUrl, out="audio.wav")
...
if __name__ == "__main__":
    ...
    textLength = phaseEncoding(textUrl, audioUrl)
